...
export const StudentEditEmail = ({onCloseStudentEditEmail, displayData, onStudentEmailChange}) => {
    //calling the sample data
    const [student_email, setEmailStudent] = useState(displayData);
    ...
    <div className="popup">
      <div className="popup-content">
                ...
                <div className='mt-5 flex felx-row-2 justify-center'>
                    ...
                    <button onClick={onCloseStudentEditEmail} className="bg-[#E2202C] hover:bg-[#E2202C] text-white font-bold py-2 px-4 rounded-xl">
                        Cancel
                    </button>                    
                </div>
