...
export default function AddLinks({ showLinks, subject, setSubject, url, setUrl, description, setDescription, onClose, onSubmit }) { //Back end edit
  if (!showLinks) {
    return null;
  }
  ...
  return (
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-full lg:w-1/4 px-4 py-6 shadow-lg rounded-lg">
            ...
            <div className="mt-2">
            <label className=" text-gray-700 text-sm mb-2" htmlFor="url">URL: </label>
            <input id="url"
                  name="url"
                  type="text"
                  required
