...
Route::middleware('auth:sanctum')->group(function() {
    ...
    //classes tab
    Route::post('/addclass', [ClassessController::class, 'addClass']); // <><><> add classes
    Route::get('/classes', [ClassessController::class, 'index']); //<><><> index classes
    Route::put('/updateclasses/{id}', [ClassessController::class, 'updateClasses']); //<><><> update user
